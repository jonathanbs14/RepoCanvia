...
@Service
public class MovimientoDJ621IGVSustittutoriaServiceImpl  implements MovimientoDJService {

    private static final Logger LOG = LoggerFactory.getLogger(MovimientoDJ621IGVSustittutoriaServiceImpl.class);
    ...
    public MovimientoDJ621IGVSustittutoriaServiceImpl(ParametriaRepository parametriaRepository, OperacionMovimientoService operacionMovimientoService) {
