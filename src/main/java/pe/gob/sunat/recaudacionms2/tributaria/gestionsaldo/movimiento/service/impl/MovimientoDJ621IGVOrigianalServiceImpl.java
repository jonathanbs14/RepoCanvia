...
@Service
public class MovimientoDJ621IGVOrigianalServiceImpl implements MovimientoDJService {

    private static final Logger LOG = LoggerFactory.getLogger(MovimientoDJ621IGVOrigianalServiceImpl.class);
    ...
    public MovimientoDJ621IGVOrigianalServiceImpl(ParametriaRepository parametriaRepository, OperacionMovimientoService operacionMovimientoService) {
    ...
    public Mono<Boolean> processMessage(String event, int retryNumber) {
        ...
        try {
            ...
            String numIdEventoSaldo = Optional.of(dataJson).map(DatosVO::getCabecera).map(CabeceraDJ::getNumIdEventoSaldo).orElse("");
            //punto 2
    ...
    public void generarMovimiento(String codCuenta, DatosVO<DataDJVO> dataJson, double mtoPercepciones, double mtoRetenciones, Date fecMovimiento, String collectionName) {
        ...
        switch (codCuenta) {
            ...
            //  coeficienteDeclarad  = operacionMovimientoService.cus06GenerarSaldosAcumulado(dataJson, casillas, coeficienteDeclarad,periodoDj, cabeceraDJ);
                coeficienteDeclarad =0.5;
                 castilla140D  = operacionMovimientoService.cus07CalcularImpuestoResultante( LOG,casillas, coeficienteDeclarad);
